    ...
    <div name="about" className={aboutStyles.content}>
      ...
      <div className={aboutStyles.container}>
        ...
        <div className={aboutStyles.description}>
          ...
          <h4>
            学習中: HTML/CSS, JavaScript, Ruby, Ruby on Rails, MySQL, React,
            Gatsby.js, GraphQL
          </h4>
          <p className={aboutStyles.paragraph}>
            ...
            スクールではサーバーサイドとしてRuby on
            Railsを用いた個人・チーム開発、独学では主にフロントサイドとしてReact/Gatsby.jsのようなモダンなJavaScriptライブラリを学習。
          </p>
        </div>
      </div>
    </div>
